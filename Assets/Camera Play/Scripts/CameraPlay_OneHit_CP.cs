...
public partial class CameraPlay : MonoBehaviour
{
    ...
    public static void OneHit(float Time)
    {
        if (CurrentCamera == null) CurrentCamera = Camera.main;
        CameraPlay_OneHit CP = CurrentCamera.gameObject.AddComponent<CameraPlay_OneHit>() as CameraPlay_OneHit;
        CP.Duration = Time;
    }
    /// <summary>
    ...
    /// <param name="Time">Set the time effect in second.</param>
    public static void OneHit(Color col, float Time)
    {
        if (CurrentCamera == null) CurrentCamera = Camera.main;
        CameraPlay_OneHit CP = CurrentCamera.gameObject.AddComponent<CameraPlay_OneHit>() as CameraPlay_OneHit;
        CP.Duration = Time;
    ...
    public static void OneHit(Color col)
    {
        if (CurrentCamera == null) CurrentCamera = Camera.main;
        CameraPlay_OneHit CP = CurrentCamera.gameObject.AddComponent<CameraPlay_OneHit>() as CameraPlay_OneHit;
        CP.Duration = 1;
