...
public class T_N1_Manager : MonoSingleton<T_N1_Manager>
{
    ...
    public void SetEquipButton(bool setActive)
    {
        ...
        //NewCanvasUI.My.Panel_TradeSetting.GetComponent<>()
    }
    
    public void SetTradeDeleteButton(bool setActive)
    {
        NewCanvasUI.My.Panel_TradeSetting.GetComponent<CreateTradeManager>().delete_btn.gameObject.SetActive(setActive);
        //NewCanvasUI.My.Panel_TradeSetting.GetComponent<>()
    }
