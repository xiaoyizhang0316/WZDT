...
public class CircleGuide : FTEBase
{
    ...
    public override void Move(Canvas canvas, RectTransform target, float scale, float time, TranslateType translateType = TranslateType.Direct, float moveTime = 1)
    {
