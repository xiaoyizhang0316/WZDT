...
public class FTEBase : MonoBehaviour
{
    ...
    public virtual void Move(Canvas canvas, RectTransform target,float scale, float time, TranslateType translateType = TranslateType.Direct, float moveTime = 1) {
