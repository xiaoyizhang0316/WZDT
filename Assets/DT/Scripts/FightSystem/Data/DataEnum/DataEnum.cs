...
public class DataUpload
{
    ...
    public int role_updateSeed;
    public int role_updatePeasant;
    public int role_updateMerchant;
    public int role_updateDealer;
