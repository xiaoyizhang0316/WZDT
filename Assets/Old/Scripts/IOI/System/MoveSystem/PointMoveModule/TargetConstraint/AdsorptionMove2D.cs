...
{
    public class AdsorptionMove2D : ITargetConstraint
    {
        public AdsorptionMove2D(float gridDiameter, int xGrid, int yGrid)
        {
        ...
        public Vector3 TargetConstraint(Transform transform, Vector3 startPosition, Vector3 originalTarget)
        {
            ...
            constraintTarget -= new Vector3((xGrid * gridDiameter - 1) / 2, (yGrid * gridDiameter - 1) / 2, 0);
